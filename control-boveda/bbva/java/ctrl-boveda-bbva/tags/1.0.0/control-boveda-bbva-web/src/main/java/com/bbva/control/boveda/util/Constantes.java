...
public class Constantes {
	...
	public static String RUTA_ARCHIVO_DSD = "D://Archivos_produccion//";
	public static String RUTA_ARCHIVO_REPORTE = "C://Users//FARAGON//Desktop//borrar//reporte//";
	public static String RUTA_ARCHIVO_LOG = "D://Archivos_produccion//";
	...
	public static String DES_PROCESO_INGRESOS = "INGRESOS";
    public static String DES_PROCESO_SALIDAS = "SALIDAS";
    public static String DES_PROCESO_RENOVADOS = "RENOVADOS";
    public static String DES_PROCESO_PROTESTADOS = "PROTESTADOS";
    public static int IND_PROCESO_EJECUTADO = 1;
    public static int IND_PROCESO_NO_EJECUTADO = 0;
    public static String PLAZA_BCP = "BCP";
    public static String NOMBRE_CHEQCAR_DOC = "CHEQCAR1.DOC";
